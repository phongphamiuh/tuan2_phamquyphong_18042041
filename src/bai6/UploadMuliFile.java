...
/**
 * Servlet implementation class UploadMuliFile
 */
@WebServlet("/uploadfile")
public class UploadMuliFile extends HttpServlet {
...
//					System.out.println("file name" + fileName+" ---file path"+file      Path);
//					File storeFile = new File(filePath);
					File storeFile = new File("T://file" + fileName);
